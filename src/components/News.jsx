          ...
          {mockNews.map((news, i) => (
            ...
            >
              <div className="h-48 bg-gray-200 overflow-hidden relative">
                <img 
                  src={`https://images.unsplash.com/photo-1572013343866-df2f5c0c9d7a?w=600&q=80`} 
                  alt="News" 
              ...
              <div className="p-6">
                <p className="text-sm text-gray-500 mb-2 font-mono">{news.date}</p>
                <h3 className="text-xl font-bold text-forest-dark mb-4">{news.title}</h3>
