...
export default function Admin() {
  ...
  const updateMemberStatus = async (member, status) => {
    if (status !== 'approved' && !window.confirm(`Reject the membership application for ${member.name}?`)) return;
    setBusy(true);
    try {
